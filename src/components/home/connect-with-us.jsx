  ...
  return (
    ...
    >
      <div className="section-container flex justify-between items-center">
        <div className="py-16">
          <h3 className="font-stolzl font-medium text-[46px] leading-[60px] text-white max-w-[900px]">
            Connect with Confidence — We’re Ready to Build What’s Next.
          </h3>
          <p className="font-stolzl max-w-[710px] text-sm text-[#FFFFFFCC] mt-4 mb-6 font-book">
