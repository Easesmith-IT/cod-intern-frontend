    ...
    >
      <div className="section-container h-full relative flex gap-4 justify-between">
        <div className="flex flex-col justify-center">
          <h1 className="text-7xl font-bold font-inter whitespace-nowrap">
            India’s <span className="text-main">#1</span> Platform
          </h1>
          <p className="font-inter text-2xl text-para mt-4">
          ...
          <Link
            href="#"
            className="text-sm font-inter underline text-[#41414199]"
          >
        ...
        <div className="relative flex justify-center items-end z-10">
          <Image width={647} height={515} src="/hero-img.svg" alt="hero-img" />
          <Image
            width={117}
            height={172}
            src="/hero-img-1.svg"
          ...
          <div className="absolute bottom-32 right-20 w-[138px] h-[129px] shadow-lg shadow-black/10 rounded-md bg-white px-3 py-4">
            ...
            <h4 className="font-medium text-sm font-inter mt-2">
              Students Enroll
            </h4>
            <p className="text-xs font-inter">100% enroll rating per month</p>
          </div>
        </div>
      </div>
      <Image
