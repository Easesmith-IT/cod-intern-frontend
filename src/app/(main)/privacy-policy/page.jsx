  ...
  return (
    <section className="section-container pt-8 md:pt-12 pb-12 md:pb-24">
      ...
      <div className="reset-block">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to CODINTERN PRIVATE LIMITED, 2nd Flr,
              Raj Ghar, Kanti, Factory Rd, Kankarbagh, Chitragupta Nagar, Patna,
              Sampatchak, Bihar, India, 800020.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to codIntern, accessible from{" "}
              <a
                href="codintern.com"
        ...
        <ul>
          <li>
            <p>By email: info@codintern.com</p>
          </li>
          <li>
            <p>By phone number: +91 7311155738</p>
          </li>
        </ul>
      </div>
    </section>
